 ...
 * @author jtalbut
 */
public class XlsxWriterColourfulTest extends AbstractXlsxWriterTest {
  ...
  public void testFile() throws Exception {
    ...
    try (FileOutputStream fos = new FileOutputStream(file)) {      
      TableDefinition defn = new TableDefinition(null, "My Data", "Jim", true, true
              , new FontDefinition(null, 8)
              , new FontDefinition(null, 8)
              , new ColourDefinition(null, "00FF00") // Red, Green
              , new ColourDefinition("0000FF", null) // Blue, Magenta
